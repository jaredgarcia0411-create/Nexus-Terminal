...
export default function Sidebar({
  ...
  <div className={`mt-auto flex flex-col gap-2 text-zinc-500 ${collapsed ? 'px-1' : 'px-2'}`}>
    ...
    <button
      ...
      className="flex items-center gap-2 rounded-lg border border-emerald-500/40 bg-emerald-500/10 px-3 py-2 text-sm font-medium text-emerald-500 transition-colors hover:bg-emerald-500/20"
      title="New Trade"
