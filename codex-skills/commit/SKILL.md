...
description: >
  ...
  explicitly asks to stage, commit, or publish the current branch. This is the user-facing alias
  for the canonical nexus-commit workflow.
---

# Commit

Use this skill only when the user explicitly asks for a commit or push.
